...
public class PopularCitiesAdapter extends FirebaseRecyclerAdapter<PopularCitiesDataHolder,PopularCitiesAdapter.myViewHolder> {
     ...
     * @param options
     */
    public PopularCitiesAdapter(@NonNull FirebaseRecyclerOptions<PopularCitiesDataHolder> options) {
        super(options);
    }
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.pcity_rv_item,parent,false);
    ...
    class myViewHolder extends RecyclerView.ViewHolder{
        ...
        public myViewHolder(@NonNull View itemView) {
            ...
            //desc = (TextView) itemView.findViewById(R.id.p_city_desc);
