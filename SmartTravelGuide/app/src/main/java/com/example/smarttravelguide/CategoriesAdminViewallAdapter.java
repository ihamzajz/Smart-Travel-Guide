...
public class CategoriesAdminViewallAdapter extends FirebaseRecyclerAdapter<CategoriesDataHolder,CategoriesAdminViewallAdapter.myViewHolder> {
     ...
     * @param optionsc
     */
    public CategoriesAdminViewallAdapter(@NonNull FirebaseRecyclerOptions<CategoriesDataHolder> optionsc) {
        super(optionsc);
    }
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.categories_admin_viewall_card,parent,false);
