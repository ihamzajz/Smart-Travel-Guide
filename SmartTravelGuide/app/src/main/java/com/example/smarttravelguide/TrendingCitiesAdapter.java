...
public class TrendingCitiesAdapter extends FirebaseRecyclerAdapter<TrendingCitiesDataHolder,TrendingCitiesAdapter.myViewHolder> {
     ...
     * @param options2
     */
    public TrendingCitiesAdapter(@NonNull FirebaseRecyclerOptions<TrendingCitiesDataHolder> options2) {
        super(options2);
    }
    ...
    public myViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.tcity_rv_item,parent,false);
